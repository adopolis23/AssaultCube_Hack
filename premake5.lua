...
project "AssaultCube_Hack_DLL"
   ...
   -- Include directories if needed
   includedirs { "AssaultCube_Hack_DLL", "AssaultCube_Hack_DLL/src/esp", "AssaultCube_Hack_DLL/src/mem", "AssaultCube_Hack_DLL/src/proc", "AssaultCube_Hack_DLL/src/include", "AssaultCube_Hack_DLL/src/OpenGlText", "AssaultCube_Hack_DLL/src/hook", "AssaultCube_Hack_DLL/src/OpenGlDraw" }
